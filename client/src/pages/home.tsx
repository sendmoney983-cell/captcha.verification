          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-gradient-to-br from-[#2d7a6e] to-[#1e5449] p-1 transition-all duration-300 hover:shadow-2xl hover:shadow-[#3dd9b3]/20">
                  <div className="bg-gradient-to-br from-[#2d7a6e]/90 to-[#1e5449]/90 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 backdrop-blur-xl">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
                      <div className="flex-shrink-0">
                        <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-[#3dd9b3] to-[#2d7a6e] flex items-center justify-center relative">
                      ...
                      <div className="flex-shrink-0">
                        <div className="bg-[#0a1614] rounded-full px-4 sm:px-6 py-2 sm:py-3">
                          <span className="text-xs sm:text-sm font-bold text-[#f5f1e8] uppercase tracking-wide" data-testid="text-claim-iusdt">
                            CLAIM iUSDT
                          </span>
                        </div>
                      </div>
