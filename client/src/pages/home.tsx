      ...
      <div className="relative">
        ...
        >
          {isWalletConnected ? (
            ...
            <button 
              className="cursor-pointer border-0 outline-none bg-[#4752c4] hover:bg-[#3b44a8] text-white font-bold rounded-xl px-10 py-4 text-lg whitespace-nowrap shadow-lg tracking-wide"
