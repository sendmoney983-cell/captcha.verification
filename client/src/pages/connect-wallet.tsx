              ...
              {wallets.map((wallet) => {
                return (
                  <button
                    ...
                    className="bg-[#1a2e2a]/30 border border-[#3dd9b3]/20 rounded p-1.5 flex flex-col items-center justify-center gap-1 hover:bg-[#1a2e2a]/50 hover:border-[#3dd9b3]/40 transition-all"
                  ...
                  >
                    ...
                    <span className="text-[10px] font-medium text-[#f5f1e8] text-center leading-tight">{wallet.name}</span>
                  </button>
                );
              })}
            </div>
